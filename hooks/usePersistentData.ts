...
const initialUsers: User[] = [
  { id: ADMIN_ID, username: 'wusva', name: 'Администратор', email: 'admin@luna.app', age: 30, bio: 'Обеспечиваю порядок и веселье в Luna Dating.', photoUrls: ['https://i.pravatar.cc/400?u=admin'], isVerified: true, isPremium: true, isBlocked: false, lastLogin: Date.now() },
  { id: 101, username: 'jessica_art', name: 'Джессика', email: 'jess@example.com', age: 24, bio: 'Люблю искусство, музыку и спонтанные приключения. Ищу кого-то с хорошим чувством юмора.', photoUrls: ['https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?q=80&w=1887&auto=format&fit=crop'], isVerified: true, isPremium: true, isBlocked: false, lastLogin: 0, height: 170, zodiacSign: 'Весы', eyeColor: 'Голубой' },
  { id: 102, username: 'mike_climbs', name: 'Майк', email: 'mike@example.com', age: 28, bio: 'Днем программист, по выходным скалолаз. Моя собака - мой лучший друг.', photoUrls: ['https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=1887&auto=format&fit=crop'], isVerified: false, isPremium: false, isBlocked: false, lastLogin: 0, height: 182, weight: 80, preferences: 'Горы, код, собаки' },
  { id: 103, username: 'chloe_travels', name: 'Хлоя', email: 'chloe@example.com', age: 26, bio: 'Путешественница и гурман. Вероятно, смогу победить тебя в Mario Kart.', photoUrls: ['https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=1961&auto=format&fit=crop'], isVerified: false, isPremium: false, isBlocked: false, lastLogin: 0, zodiacSign: 'Стрелец', badHabits: 'Прокрастинация' },
  { id: 104, username: 'david_fit', name: 'Давид', email: 'david@example.com', age: 31, bio: 'Фитнес-энтузиаст и начинающий шеф-повар. Верю, что хороший разговор — лучшее первое свидание.', photoUrls: ['https://images.unsplash.com/photo-1522529599102-193c0d76b5b6?q=80&w=2070&auto=format&fit=crop'], isVerified: true, isPremium: false, isBlocked: false, lastLogin: 0, height: 185, weight: 85 },
];
